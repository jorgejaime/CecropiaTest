...
namespace Jorge.Inventory.Services.Messaging
{
    public static class ProductMapping
    {
        ...
        public static List<Product> ToProductList(this IEnumerable<ProductView> list)
        {
            return Mapper.Map<List<Product>>(list);
        }


        public static List<ProductView> ToProductViewList(this IEnumerable<Product> list)
        {
